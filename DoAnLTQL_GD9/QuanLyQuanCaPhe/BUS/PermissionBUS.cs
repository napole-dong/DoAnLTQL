...
public class PermissionBUS : IPermissionService
{
    private readonly IPermissionRepository _permissionDAL;
    private static readonly AuthorizationPolicyOptions AuthorizationPolicy = new()
    {
        AllowManagerEditMenuPrice = true
    };

    public PermissionBUS(IPermissionRepository? permissionDAL = null)
    {
        _permissionDAL = permissionDAL ?? new PermissionDAL();
    }
