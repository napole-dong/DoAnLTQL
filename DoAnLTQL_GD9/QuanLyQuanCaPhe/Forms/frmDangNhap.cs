...
namespace QuanLyQuanCaPhe.Forms
{
    ...
    {
        private readonly IDangNhapService _dangNhapBUS;
        ...
        public frmDangNhap(IDangNhapService? dangNhapBUS = null)
        {
            _dangNhapBUS = AppServiceProvider.Resolve(dangNhapBUS, () => new DangNhapBUS());
            InitializeComponent();
