    ...
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            try
            {
                ...
                KhoiTaoDuLieuQuyenMacDinh(serviceProvider);

                while (true)
                {
                    DangXuatDieuHuongService.DatLaiYeuCauDangNhapLai();

                    using var frmDangNhap = serviceProvider.GetRequiredService<Forms.frmDangNhap>();
                    ...
                    using var frmBanHang = serviceProvider.GetRequiredService<Forms.frmBanHang>();
        ...
        private static void KhoiTaoDuLieuQuyenMacDinh(IServiceProvider serviceProvider)
        {
            ...
            var permissionBUS = serviceProvider.GetRequiredService<IPermissionService>();
