...
namespace QuanLyQuanCaPhe.Forms
{
    public partial class frmQuanLiKho : Form
    {
        ...
        public frmQuanLiKho()
        {
            ...
            colTrangThaiKho.DataPropertyName = nameof(NguyenLieuDTO.TrangThai);
        ...
        private void LoadDanhSachKho()
        {
            ...
            lblSapHetValue.Text = dsNguyenLieu.Count(x => x.TrangThai.Equals("Sắp hết", StringComparison.OrdinalIgnoreCase)).ToString();
            lblHetHangValue.Text = dsNguyenLieu.Count(x => x.TrangThai.Equals("Hết hàng", StringComparison.OrdinalIgnoreCase)).ToString();
        ...
        private void dgvDanhSachKho_SelectionChanged(object? sender, EventArgs e)
        {
            ...
            var trangThaiIndex = cboTrangThai.FindStringExact(nguyenLieu.TrangThai);
