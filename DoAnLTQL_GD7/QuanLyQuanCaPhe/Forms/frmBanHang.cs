...
namespace QuanLyQuanCaPhe.Forms
{
    public partial class frmBanHang : Form
    {
        ...
        public frmBanHang()
        {
            ...
            btnHoaDon.Click += (_, _) => MoTinhNangHoaDon();
        ...
        private void frmBanHang_Load(object? sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Bạn không có quyền truy cập chức năng Bán hàng.", "Từ chối truy cập", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                Close();
                return;
            }
        ...
        private void HienThiNguoiDungDangNhap()
        {
            ...
            lblUserName.Text = $"{nguoiDungDangNhap.HoVaTen} ({nguoiDungDangNhap.QuyenHan})";
        }
        ...
        private void ApDungPhanQuyenLenUI()
        {
            ...
            var coQuyenNhanVien = _permissionBUS.CheckPermission(PermissionFeatures.NhanVien, PermissionActions.View);
            var coQuyenThongKe = _permissionBUS.CheckPermission(PermissionFeatures.ThongKe, PermissionActions.View);

            btnQuanLyBan.Visible = coQuyenMenu;
            btnQuanLyMon.Visible = coQuyenMenu;
            btnHoaDon.Visible = coQuyenMenu;
            btnKhachHang.Visible = coQuyenMenu;
            btnNhanVien.Visible = coQuyenNhanVien;
            btnThongKe.Visible = coQuyenThongKe;

            var coQuyenCapNhatBanHang = _permissionBUS.CheckPermission(PermissionFeatures.BanHang, PermissionActions.Update);
            btnTamTinh.Enabled = coQuyenCapNhatBanHang;
            btnThanhToan.Enabled = coQuyenCapNhatBanHang;
            btnChuyenBan.Enabled = coQuyenCapNhatBanHang;
            btnGopBan.Enabled = coQuyenCapNhatBanHang;
        }
