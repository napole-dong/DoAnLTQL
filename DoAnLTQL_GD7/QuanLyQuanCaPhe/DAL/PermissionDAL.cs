...
public class PermissionDAL
{
    ...
    {
        [PermissionFeatures.NhanVien] = new PermissionTemplate(canView: true, canCreate: true, canUpdate: true, canDelete: false),
    ...
    public bool CheckPermission(int roleId, string feature, string action)
    {
        ...
        DamBaoDuLieuQuyenMacDinh(context);
    ...
    private static void DamBaoDuLieuQuyenMacDinh(CaPheDbContext context)
    {
        var dsVaiTro = QueryDanhSachVaiTroRows(context);
        if (dsVaiTro.Count == 0)
        {
